...
set_target_properties(FreeGLUT::freeglut PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib64/libglut.so.3.11.1"
  IMPORTED_SONAME_NOCONFIG "libglut.so.3"
  )

list(APPEND _IMPORT_CHECK_TARGETS FreeGLUT::freeglut )
list(APPEND _IMPORT_CHECK_FILES_FOR_FreeGLUT::freeglut "${_IMPORT_PREFIX}/lib64/libglut.so.3.11.1" )
...
set_target_properties(FreeGLUT::freeglut_static PROPERTIES
  ...
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib64/libglut.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS FreeGLUT::freeglut_static )
list(APPEND _IMPORT_CHECK_FILES_FOR_FreeGLUT::freeglut_static "${_IMPORT_PREFIX}/lib64/libglut.a" )
